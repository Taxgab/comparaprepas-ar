...
name: bird-twitter
description: >
  Publicá, leé y gestioná tweets en Twitter/X usando el CLI bird.
  Usá cuando el usuario pida "posteá un tweet", "leé este tweet", "buscá tweets sobre", o "mostrá mi timeline".
  Ejemplos: "posteá este hilo", "leé el tweet 123456", "buscá tweets sobre AI", "mostrá mi timeline"
...
- [ ] Verificá que `AUTH_TOKEN` y `CT0` están configurados
- [ ] Ejecutá `bird check` para validar credenciales
- [ ] Verificá que el comando no es destructivo (delete, unfollow)
- [ ] Confirmá con el usuario si es una acción irreversible

## Herramientas Permitidas

Esta skill solo puede usar:
- `Bash` - Para ejecutar comandos `bird`
- `Read` - Para leer archivos de configuración

**NO PUEDE:**
- `Write` - No modificar archivos sin permiso
- `Edit` - No editar configuración
